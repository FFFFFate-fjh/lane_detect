...
//        Mat ROI_img = set_ROI(src_heq,ROI_x, ROI_y, 600, 369-ROI_y);
                Mat ROI_img2 = set_ROI(src_heq,75, 230, 960-75, 540-230);
                Mat ROI_img = set_ROI(src_heq,ROI_x, ROI_y, 600, 540-ROI_y);
        Mat grad, abs_grad_x;
...
//                bn_points_vec.push_back(b2);
    ...
    br = opt_stddev(bp_points_vec,50,bldev);
    bl = opt_stddev(bn_points_vec,50,brdev);
